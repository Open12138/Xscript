...
/**
 * This class represents a less or equal comparison.
 *
 * @author Herbert Czymontek
 */
public final class LessOrEqualExpression extends OrderedComparisonExpression {

  /**
   * Creates a new expression for a less or equal comparison.
   * 
   ...
   */
  public LessOrEqualExpression(long position, Expression leftOperand, Expression rightOperand) {
  ...
  public void generate(Method m) {
    ...
    leftOperand.type.generateBranchIfCmpLessOrEqual(m, trueLabel);
  ...
  public void generateBranchOnFalse(Method m, Method.Label falseLabel) {
    super.generate(m);
    leftOperand.type.generateBranchIfCmpGreater(m, falseLabel);
  }
