...
/**
 * This class represents a greater comparison.
 *
 * @author Herbert Czymontek
 */
public final class GreaterExpression extends OrderedComparisonExpression {

  /**
   * Creates a new expression for a greater comparison.
   * 
   ...
   */
  public GreaterExpression(long position, Expression leftOperand, Expression rightOperand) {
  ...
  public void generate(Method m) {
    ...
    leftOperand.type.generateBranchIfCmpGreater(m, trueLabel);
  ...
  public void generateBranchOnFalse(Method m, Method.Label falseLabel) {
    super.generate(m);
    leftOperand.type.generateBranchIfCmpLessOrEqual(m, falseLabel);
  }
