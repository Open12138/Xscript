...
/**
 * This class represents a not equal comparison.
 *
...
public final class NotEqualExpression extends ComparisonExpression {
  ...
  /**
   * Creates a new expression for a not equal comparison.
   *
   ...
   */
  public NotEqualExpression(long position, Expression leftOperand, Expression rightOperand) {
  ...
  public void generate(Method m) {
    ...
    leftOperand.type.generateBranchIfCmpNotEqual(m, trueLabel);
  ...
  public void generateBranchOnFalse(Method m, Method.Label falseLabel) {
    super.generate(m);
    leftOperand.type.generateBranchIfCmpEqual(m, falseLabel);
  }
