...
/**
 * This class represents a less comparison.
 *
 * @author Herbert Czymontek
 */
public final class LessExpression extends OrderedComparisonExpression {

  /**
   * Creates a new expression for a less comparison.
   * 
   ...
   */
  public LessExpression(long  position, Expression leftOperand, Expression rightOperand) {
