...
/**
 * This class represents a greater or equal comparison.
 *
 * @author Herbert Czymontek
 */
public final class GreaterOrEqualExpression extends OrderedComparisonExpression {

  /**
   * Creates a new expression for a greater or equal comparison.
   *
   ...
   */
  public GreaterOrEqualExpression(long position, Expression leftOperand, Expression rightOperand) {
  ...
  public void generate(Method m) {
    ...
    leftOperand.type.generateBranchIfCmpGreaterOrEqual(m, trueLabel);
  ...
  public void generateBranchOnFalse(Method m, Method.Label falseLabel) {
    super.generate(m);
    leftOperand.type.generateBranchIfCmpLess(m, falseLabel);
  }
