...
public class ColorPickerDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        colored = (EditText) v.findViewById(R.id.colored);
        ...
        mColorPicker.setOnColorChangedListener(new OnColorChangedListener() {
            ...
            public void onColorChanged(int newColor) {
                ...
                colored.setText("#" + Integer.toHexString(mColorPicker.getColor()).toUpperCase());
            }
        });
        colored.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void afterTextChanged(Editable s) {
                try {
                    ...
                    if (str.startsWith("#")) {
                        mColorPicker.setColor(Color.parseColor(str));
                        mNewColorPanel.setColor(Color.parseColor(str));
                    }
                } catch (Exception e) {
